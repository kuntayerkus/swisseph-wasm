 ...
 */
export const EXTENDED_ASTEROIDS = [
    { number: 1, name: "Ceres" },
...
export const extendedAsteroidName = (number) => EXTENDED_ASTEROIDS.find((a) => a.number === number)?.name;
//# sourceMappingURL=asteroid-names.js.map